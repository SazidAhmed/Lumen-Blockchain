...
class BlockServices{
    ...
    public function calculateHash($data, $previousHash, $timestamp, $nonce){
        return hash('sha256', $timestamp.$data.$previousHash.$nonce);
    }
    ...
    public function createGenesisBlock(){
        ...
        $previousHash = "0";
        $nonce = 0;
        return $this->createblock($data, $previousHash, $timestamp, $nonce);
    }
